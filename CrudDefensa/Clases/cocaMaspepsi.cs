...
{
    public partial class coca_mas_pepsi : Form
    {
        ...
        private void cargarinventario()
        {
            ...
            using (NpgsqlConnection conexion = new NpgsqlConnection(cadenaConexion))
            {
                try
                {
                    ...
                    // Consulta SQL
                    string consulta = "SELECT * FROM tiendas_coca_mas_pepsi ";
        ...
        private void bdcocapepsi()
        {
            using (var connection = new NpgsqlConnection(cadenaConexion))
            {
                connection.Open();

                using (var cmd = new NpgsqlCommand("SELECT * FROM tiendas_coca_mas_pepsi ", connection))
                {
